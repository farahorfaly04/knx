...
from xknx.dpt.dpt_10 import KNX2Time as XknxTime
...
async def async_setup_entry(
    ...
    config: list[ConfigType] = knx2_module.config_yaml[Platform.TIME]

    async_add_entities(
        KNX2TimeEntity(knx2_module, entity_config) for entity_config in config
    )
...
class KNX2TimeEntity(Knx2YamlEntity, TimeEntity, RestoreEntity):
    """Representation of a KNX2 time."""
